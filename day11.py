...
# calculate full grid first
def calculate_fuel_grid():
    # grid is 300x300
    # store the grid as a dict: {(1,1):3, (2,1):4...etc}
    ...
    for x in range(1, 300):
        for y in range(1, 300):
            ...
            print(power)
            # step 5-6
            actual_power = int(str(power)[::-1][2]) - 5
            grid[(x, y)] = actual_power
    return grid


serial = 8561
grid = calculate_fuel_grid()
pprint.pprint(grid)